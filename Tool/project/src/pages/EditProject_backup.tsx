...
export function EditProject() {
  ...
  const handleSave = async () => {
    setLoading(true);
    try {
      // Prepare the payload for API - map form values to API format
      const payload = {
        name: formData.name,
        ...
        client: formData.client_id || undefined,
        owner: formData.owner_id || undefined,
      ...
      // Update the global state with the updated project
      const updatedProject = {
        ...
        monthly_hour_allocation: formData.monthly_hour_allocation,
        tags: formData.tags,
